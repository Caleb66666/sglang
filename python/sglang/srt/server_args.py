...
class ServerArgs:
    ...
    def check_server_args(self):
        ...
        if self.lora_paths:
            ...
            logger.info("Automatically enabling LoRA support due to provided LoRA paths.")
        ...
        if self.enable_lora:
            ...
            assert self.lora_paths or self.max_lora_rank, "either lora_paths or max_lora_rank must be set when LoRA support is enabled."
