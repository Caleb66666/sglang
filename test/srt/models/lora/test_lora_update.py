...
TEST_CASES = [
    TestCase(
        description="test dynamic lora update without initial lora_paths",
    ...
    # TestCase(
    #     description="test dynamic lora update without max-lora_rank",
    #     base="meta-llama/Llama-3.1-8B-Instruct",
    ...
    # ),
    # TestCase(
    #     description="test dynamic lora update with evictions",
    #     base="meta-llama/Llama-3.1-8B-Instruct",
...
class LoRAUpdateServerTestSession(LoRAUpdateTestSessionBase):
    ...
    def __enter__(self):
        ...
        if self.enable_lora is not None:
...
class TestLoRADynamicUpdate(CustomTestCase):
    ...
    def _run_operation_sequence(
        ...
        max_loras_per_batch: int,
        op_sequence: List[Operation],
        initial_adapters: Optional[List[str]],
        max_lora_rank: Optional[int] = None,
        enable_lora: Optional[bool] = None,
        max_new_tokens: int = 32,
    ) -> List[tuple]:
